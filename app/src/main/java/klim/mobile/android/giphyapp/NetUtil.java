...
public class NetUtil {
    ...
    public static GiphyImage getGiphy (JSONObject object) throws JSONException, IOException {
        JSONObject imgObject = object.getJSONObject("data");
        String tmpId = imgObject.getString("id");
        String tmpUrl = imgObject.getString("fixed_height_small_still_url");
        URL url = new URL(tmpUrl);
        Bitmap tmpBitmap = BitmapFactory.decodeStream(url.openConnection().getInputStream());

        return new GiphyImage(tmpUrl,tmpId,tmpBitmap);
    }
